...
function printBookList(atfiltruotosKnygos) {
    ...
    //testine eilute
   /* paveiksliukas = document.createElement("img");
    paveiksliukas.src = atfiltruotosKnygos[0].picture;
    //DOM_img.src = "typo3conf/ext/ori_proyectos/res/images/interes.png";
    paveiksliukas.setAttribute = ("src", "img/bootstrap.jpg");
    rezultatuIdejimoVieta.appendChild(paveiksliukas);*/
    
    
    
    
    atfiltruotosKnygos.forEach(function (item, index, objektas) { //buvo parašyta (item, index, objektas)
